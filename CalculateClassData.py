...
dataAllZip = [line.strip() for line in open('zipFinalVersionClustering.csv')]
...
for domain in arrayMergeData:
    ...
    probabilityClickRegion1=arrayDomainCount1[int(domain[-1])]*1.0/arrayDomainCount0[int(domain[-1])]

    probabilityClickLink=arrayDomainCount1[0]*1.0/arrayDomainCount0[0]
    probabilityClickRegion2=arrayDomainCount1[int(domain[-1])]*1.0/arrayDomainCount0[int(domain[-1])]
#    arrayMergeFinalData.append([probabilityClickAdvartisment,probabilityClickRegion1,probabilityClickLink,probabilityClickRegion2]+domain[1:len(domain)-1]+[domain[0]])
    arrayMergeFinalData.append([probabilityClickAdvartisment,probabilityClickRegion1,probabilityClickLink,probabilityClickRegion2]+domain[0:4]+domain[5:len(domain)-1]+[domain[0]])
